...
# 	def start_predicting(self, event):
# 		pass
	...
	def set_events(self):
		...
		# self.prediction_timer = self.fig.canvas.new_timer(interval=100)
		# self.prediction_timer.add_callback(self.likelihood_prediction, self.ax_dx)
