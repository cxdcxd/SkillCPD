...
public class Statics
{
    ...
    public static bool is_rrs_network_inited = false;
    ...
    private void Initialize()
    {
        ...
        Statics.main_tele_network = new Network<RVector7, RVector7>("172.30.50.164", "172.30.127.41", "9870", "9871", "0", NetworkType.PUBSUB, "Tele", false);
        Statics.main_tele_network.eventDataUpdated += Main_tele_network_eventDataUpdated;
        Statics.main_cpd_network = new Network<RRSCPDCommand, RRSCPDResult>("172.30.50.164", "172.30.127.41", "9872", "9873", "0", NetworkType.PUBSUB, "CPD", false);
        Statics.main_cpd_network.eventDataUpdated += Main_cpd_network_eventDataUpdated;


        is_rrs_network_inited = true;
